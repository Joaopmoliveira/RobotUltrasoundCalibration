...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]){
    ...
    if (nrhs > 4)
        mexErrMsgTxt("The function takes at maximum fours arguments");

    int n_iterations = 1000;
    bool initial_guess_exists = false;
    ...
    cpp_solver_calibration(n_wires,n_iterations,n_observations,inImageData,inTransformData,outSolutionData);
    return;
}